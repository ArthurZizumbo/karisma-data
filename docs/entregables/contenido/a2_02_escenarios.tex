...
\elemento{Expectativas del usuario}{qué espera del producto en esta situación}

Laura espera que el portal le indique cuál es la fuente vigente, qué significa la variable
y quién la respalda sin obligarla a conocer la estructura de las bases ni a pedir ayuda. Al
obtener el dato, espera conservar la fuente y la fecha para poder defender su respuesta.
...
El resultado le da \textbf{respaldo}: puede sostener la cifra ante una pregunta y reutilizar
la consulta la próxima vez, cambiando solo el periodo. La velocidad importa, pero la confianza
proviene de conservar la procedencia.

\elemento{Excepciones}{situaciones poco frecuentes con consecuencias de diseño}

\begin{uxlist}
\lead{La fuente no responde}{la fuente institucional de créditos está en mantenimiento. El portal muestra el
...
Diego espera identificar las incompatibilidades de periodicidad y granularidad antes de
procesar el volumen completo. También espera probar una muestra, ejecutar la extracción sin
bloquear su trabajo y conservar una consulta que otra persona pueda repetir.
...
El procedimiento reejecutable le da \textbf{control}: puede explicar cada cifra sin depender
de su memoria y otra persona puede repetir el análisis. Entregar el dato sin esa trazabilidad
resolvería solo la mitad de la tarea.
...
El mapa cubre desde el encargo hasta que el procedimiento queda guardado y compartido. La
curva muestra que las principales caídas no ocurren durante la extracción, sino al estimar la
viabilidad del cruce y al detectar granularidades incompatibles.

El \textbf{momento de la verdad} es el descubrimiento de una fuente relacionada que Diego no
conocía. Para sostener ese valor, el diseño debe anticipar cobertura, periodicidad e
incompatibilidades antes de ejecutar el volumen completo.
...
Arturo espera encontrar una vista lista para interpretar, con pocas cifras, variaciones
visibles y el contexto necesario para explicar cualquier movimiento. Espera además que cada
indicador muestre su conciliación y fecha de corte sin exigirle una investigación adicional.
...
La misma vista muestra el \textbf{sello de conciliación} del indicador, con quién lo validó y
...
El resultado aporta \textbf{certeza institucional}: Arturo puede explicar la cifra y evitar
quedar expuesto ante una discrepancia. Por eso, la conciliación y la fecha de corte son tan
importantes como la rapidez del tablero.
...
Roberto espera publicar una definición con vigencia, historial e impacto visibles antes de
confirmar el cambio. También espera que el portal avise solamente a las personas afectadas y
conserve evidencia de la publicación, las versiones y los destinatarios.
...
El resultado le da \textbf{tranquilidad institucional}: deja de concentrar consultas y reduce
los errores derivados de versiones antiguas. La definición que publica queda disponible para
Laura y para cualquier otra persona afectada.
...
Este recorrido concentra cinco etapas en quince minutos. A diferencia del perfil operativo,
Arturo no busca datos: interpreta una vista ya preparada y decide si puede responder por ella.

El \textbf{momento de la verdad} ocurre cuando la gráfica muestra el contexto escrito por el
propietario. La vista directiva debe favorecer lectura inmediata, variaciones visibles y una
explicación verificable, en lugar de ofrecer más opciones de exploración.
...
Mariana espera ver las consecuencias de cada rol antes de asignarlo y vincular todo permiso
con su justificación, autorización y vigencia. Espera que el historial permanezca disponible
para demostrar altas, cambios y bajas sin reconstruir la evidencia en varios sistemas.
...
El historial le da \textbf{respaldo}: el sistema conserva el rastro de cada autorización y
cambio. Un alta rápida sin esa evidencia ahorraría tiempo inmediato, pero aumentaría el riesgo
de auditoría.
...
Ximena espera encontrar un contrato de datos documentado y versionado, obtener credenciales
sin abrir un ticket y probar el servicio con una muestra pequeña. Después de la integración,
espera recibir avisos anticipados y disponer de una transición cuando cambie el esquema.
...
El resultado genera \textbf{confianza en el proveedor de datos}. Un contrato estable y los
avisos anticipados hacen preferible el servicio institucional frente a las descargas locales
que fragmentan la información.
...
El mapa extiende el recorrido varias semanas, hasta el primer cambio de esquema. Esa etapa
posterior al uso determina si Ximena mantiene la integración o vuelve a descargar archivos.

El \textbf{momento de la verdad} es la publicación del contrato versionado, porque permite
detectar cambios antes de producción. El diseño debe tratar la estabilidad y la comunicación
anticipada como funciones del producto, no como acuerdos informales.
