...
\subsection{Modo oscuro, fuera de alcance y declarado}

El sistema entrega una sola paleta. Un modo oscuro mal contrastado resta más de lo que suma, y verificar dos paletas completas con la matriz de 44 pares no cabe en la semana. Queda registrado en la bitácora de la sección 11 como entrada abierta de la versión 1.1, con la condición de entrada explícita: se publica cuando su matriz de contraste esté calculada por el mismo generador y con el mismo umbral, no antes.
