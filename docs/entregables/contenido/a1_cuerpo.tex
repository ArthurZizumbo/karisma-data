...
dependan únicamente del retrato individual. Además, los ocho perfiles de la sección 1 son
categorías de audiencia para la investigación; el control de acceso del producto se resuelve
con cuatro roles operativos: operativo, analista, directivo y administrador.
...
precisas, y deben evitar al usuario promedio, cuyo retrato no representa a nadie (Hartson y
Pyla, 2012). Por eso cada persona tiene nombre completo, historia laboral, situación
personal, herramientas concretas y un escenario de uso, en lugar de una descripción genérica
del puesto.

Existe además un riesgo particular en este proyecto: los integrantes del equipo trabajan en el
mismo dominio que se está diseñando, lo que facilita el sesgo de diseñar para uno mismo. Las
personas sirven precisamente para contrarrestar esa tendencia (Hartson y Pyla, 2012): las
ocho cumplen aquí esa función de control, porque obligan a evaluar cada decisión desde
perfiles cuyas prioridades no coinciden con las del equipo.
