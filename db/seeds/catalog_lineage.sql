...
FROM (VALUES
    ...
    ('creditos', 3, 'transformacion', 'KRS-Semantica', 'Capa semantica Karisma',
     ...
     'Riesgo de Credito', 'Sofia Aranda', DATE '2023-07-01', NULL::date),
    ...
    ('liquidez', 1, 'origen', 'TESO-Pos', 'Posiciones de tesoreria TESO',
     'origin_capture', 'TESO-Pos.POSICION_DIA',
     'Tecnologia de Tesoreria', 'Bruno Lara', DATE '2019-04-01', NULL::date),
    ...
    ('liquidez', 3, 'transformacion', 'KRS-Semantica', 'Capa semantica Karisma',
     ...
     'Tesoreria', 'Adriana Cortes', DATE '2023-09-01', NULL::date),
    ...
    ('garantias', 1, 'origen', 'GAR-Col', 'Gestor de colaterales GAR',
     ...
     'Tecnologia de Credito', 'Rosa Elizondo', DATE '2019-02-01', NULL::date),
    ...
    ('garantias', 3, 'transformacion', 'KRS-Semantica', 'Capa semantica Karisma',
     ...
     'Direccion de Credito', 'Marcela Rios', DATE '2023-05-01', NULL::date),
    ...
    ('provisiones', 3, 'transformacion', 'KRS-Semantica', 'Capa semantica Karisma',
     ...
     'Riesgo de Credito', 'Sofia Aranda', DATE '2023-12-01', NULL::date),
    ...
    ('tesoreria', 1, 'origen', 'TES-Flu', 'Flujo de efectivo TES',
     'origin_capture', 'TES-Flu.FLUJO_DIA',
     'Tecnologia de Tesoreria', 'Bruno Lara', DATE '2019-07-01', NULL::date),
    ('tesoreria', 2, 'extraccion', 'KRS-Ingesta', 'Ingesta Karisma',
     'stream_extract', 'stream_tesoreria_intradia',
     'Plataforma de Datos', 'Nadia Robles', DATE '2023-03-01', NULL::date),
    ('tesoreria', 3, 'transformacion', 'KRS-Semantica', 'Capa semantica Karisma',
     'business_rule', 'regla_flujo_proyectado_simulado',
     'Tesoreria', 'Adriana Cortes', DATE '2024-02-15', NULL::date),
    ('tesoreria', 4, 'calidad', 'KRS-Calidad', 'Control de calidad Karisma',
    ...
    ('canales', 1, 'origen', 'CAN-Ori', 'Originacion multicanal CAN',
