...
El protocolo se preparó para Carlos René Flores M. y Verónica Itzel Flores González, dos perfiles
profesionales proporcionados por el equipo. Los resultados incluidos se presentan como una
\textbf{simulación académica de dos sesiones}: permiten completar y revisar el instrumento, pero
no se declaran como observaciones de campo ni se atribuyen citas textuales a los participantes.
Una aplicación real debe sustituir estos valores por tiempos, errores, respuestas y notas
recabados durante sesiones realizadas con consentimiento.
\end{uxnota}
