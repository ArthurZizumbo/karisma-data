...
\figuraux{figuras/a3_dendrograma.png}
{Agrupamiento resultante del ejercicio de card sorting.}{fig:a5-card-sorting}

Los resultados originales fueron una simulación de diseño con evaluadores prototipo, no una
investigación de campo. Su función fue comparar hipótesis de estructura antes de construir las
pantallas; la Actividad 5 dirige la evaluación a tareas observables en el demo.
...
\figuraux{figuras/a3_arquitectura_informacion.png}
