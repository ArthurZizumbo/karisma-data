...
sus secciones puntuadas; la tabla que declara hasta dónde llega cada pantalla; y una pre-validación
sobre capturas reales del prototipo con al menos una iteración documentada.
...
Este equipo construyó los prototipos \textbf{en el entorno del producto} --- Nuxt 4 sobre FastAPI,
con PostgreSQL detrás --- en lugar de dibujarlos en un archivo de diseño. La decisión no es una
excepción al objetivo de la actividad sino una forma más estricta de cumplirlo, y conviene
sostenerla contra lo que la propia rúbrica pide de un prototipo de alta fidelidad, propiedad por
propiedad.
...
Nada se pierde con la sustitución. Este documento entrega todo lo que un archivo de diseño
entregaría --- el sistema de tokens completo, el inventario de componentes con sus estados, la
retícula y la matriz de contraste verificada por cálculo --- y añade lo que aquel archivo no puede
entregar: pantallas que responden. Cada figura de la sección de prototipos es una captura de la
aplicación en funcionamiento, tomada a resolución fija con un guion reproducible que se documenta en
el anexo.
...
\begin{uxlist}
  ...
  \lead{Sección 4. Pre-validación e iteración}{El protocolo con los ocho evaluadores prototipo, las
    dos tareas heredadas de la prueba de árbol de la Actividad 3, y el hallazgo que produjo un
    cambio, con el antes y el después lado a lado.}
  \lead{Sección 5. Alcance declarado}{Hasta dónde llega cada pantalla y cada historia de usuario, en
    tres estados, sin dejar ninguna sin declarar.}
  \lead{Sección 6. Cierre}{Qué se construyó en cifras, qué cambió por evidencia y qué se lleva la
    Actividad 5.}
