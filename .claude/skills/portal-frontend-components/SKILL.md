...
- TailwindCSS v4 con **tokens del sistema de diseño** (`@theme` en `app/assets/css/main.css`) — paridad Figma↔Nuxt exigida por A4; nunca colores/espaciados mágicos inline.
...
## Tokens Tailwind v4 (paridad Figma)
...
@theme {
  --color-accent: #0f5e9c;        /* mismo nombre de token que en Figma (A4) */
...
- [ ] Tokens `@theme` alineados con Figma (nombres idénticos)
